  ...
  return (
    <div className="w-64 bg-white min-h-screen flex flex-col fixed left-0 top-0 z-50 border-r border-slate-100 shadow-[4px_0_24px_-12px_rgba(0,0,0,0.1)]">
      ...
      <div className="p-6 flex items-center gap-2 mb-2">
        ...
        <h1 className="text-slate-800 font-bold text-xl tracking-tight">CloudText</h1>
      </div>

      <nav className="flex-1 px-4 space-y-1.5">
        <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-3 px-2 mt-2">
          Overview
        </div>
        ...
        <button className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-slate-500 hover:bg-slate-50 hover:text-slate-700 transition-colors text-sm font-medium">
